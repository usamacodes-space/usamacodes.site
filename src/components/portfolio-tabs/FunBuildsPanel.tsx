        ...
        {builds.map((build, i) => (
          <li key={build.id ?? `${build.url}-${build.title}-${i}`} className="bento-animate">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-stretch gap-3 sm:gap-4 rounded-2xl p-3 sm:p-4 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#f97316]/55 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
              style={{
              ...
              aria-label={`${build.title} — opens live demo in a new tab`}
            >
              <div
