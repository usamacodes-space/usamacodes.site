exports.id=993,exports.ids=[993],exports.modules={66149:(a,b,c)=>{"use strict";c.d(b,{Jq:()=>g,W6:()=>e,dM:()=>f});let d=function(a){let b=a.trim().replace(/\/$/,"");return b.startsWith("http")?b:`https://${b}`}(process.env.NEXT_PUBLIC_SITE_URL||"https://usamacodes.space"),e=d,f=new URL(d).hostname,g="string"==typeof process.env.NEXT_PUBLIC_CONTACT_EMAIL&&process.env.NEXT_PUBLIC_CONTACT_EMAIL.trim()||`hello@${f}`},78335:()=>{},78677:(a,b,c)=>{"use strict";c.d(b,{fB:()=>j,s0:()=>g});var d=c(66149);let e=d.Jq,f=d.W6,g=[{id:"fun-builds:this-portfolio",title:"This portfolio",description:"Interactive terminal, AI Q&A, and the page you are on right now.",url:f,emoji:"✨",status:"live"}],h=`
Usama Shafique
...
- Preferred communication: email (${d.Jq}) or LinkedIn.
- Languages: English (professional), Urdu (native).
`,i=[{question:"What is your primary tech stack?",answer:"I specialize in the T3/JavaScript ecosystem. My core backend stack includes NestJS, Node.js, and PostgreSQL. On the frontend, I work with React, Next.js, and Tailwind CSS."},{question:"How do you handle AI integration?",answer:"I focus on RAG (Retrieval-Augmented Generation) pipelines. I use LangChain to orchestrate models, FastAPI for lightweight AI microservices, and Ollama or Gemini for the LLM core."},{question:"Are you open to remote work or relocation?",answer:"I have extensive experience working remotely with international teams (UK, Pakistan). I am currently based in Stoke-on-Trent, UK, and open to hybrid or remote opportunities within the region."},{question:"Can you help with legacy code migration?",answer:"Yes, I have experience refactoring older Express.js or PHP systems into modern, type-safe NestJS architectures with better scalability and Docker containerization."}];function j(){let a=i.map(a=>`Q: ${a.question}
A: ${a.answer}`).join("\n\n"),b=g.length>0?`

=== PROJECTS FOR FUN (live demos) ===
${g.map(a=>`${a.title} (${a.status??"live"}): ${a.description} — ${a.url}`).join("\n")}`:"";return`${h.trim()}
...
Email: ${e}
Portfolio: ${f}
LinkedIn: https://linkedin.com/in/usamacodes-space
GitHub: https://github.com/usamacodes-space${b}`}},96487:()=>{}};